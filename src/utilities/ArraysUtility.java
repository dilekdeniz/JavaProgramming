...
public class ArraysUtility {
    ...
    //prints each decimal of  double array in separate lines
    ...
    public static boolean contains(int[] array, int element) {
        ...
        for (int each : array) {
            if (each == element) {//if any arrays element is matching with the given element,
                // it means the given element is contained in the array
                result = true;
            }
        }
        return result;
    ...
    //checks if the given double contained in the given array, returns boolean
